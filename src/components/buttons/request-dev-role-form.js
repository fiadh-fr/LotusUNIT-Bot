...
module.exports = {
  ...
  async execute(interaction, client) {
    const devConfirmationEmbed = new EmbedBuilder()
    ...
    collector.on("collect", async (i) => {
      if (i.customId === "collector:confirm") {
        const modal = new ModalBuilder()
          ...
          .setTitle(`Lotus UNIT - Desenvolvedor`);
        ...
        const experienceInfo = new TextInputBuilder()
          ...
          .setRequired(true)
          .setPlaceholder(
            "Bots, software, website, API, Data Analist, etc... Frontend, Backend ou Fullstack."
          )
          .setMinLength(5)
